...
class FZSXDetailActivity : BaseActivity() {
    lateinit var projectBean: ProjectDetailByIdEntity.DataBean
    lateinit var fzsxInfoAdapter: FzsxInfoAdapter
    ...
    override fun initData() {
        title_name.text = "仿真实训"
        getProjectById("668216091448709120")
                ...
                .subscribe(object : DisposableObserver<Response<ProjectDetailByIdEntity>>() {
                    override fun onNext(response: Response<ProjectDetailByIdEntity>) {
                        ...
                        if (entity.code == 0) {
                            ...
                            fzsxInfoAdapter.setDataList(projectInfoCOlBeans)
                            return
                        }
                    }
