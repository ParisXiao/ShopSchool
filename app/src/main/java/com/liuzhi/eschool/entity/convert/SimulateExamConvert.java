...
public class SimulateExamConvert implements Converter<SimulationEntity> {

    @Override
    public SimulationEntity convertResponse(Response response) throws Throwable {
        ...
        if (TextUtils.isEmpty(data) || !JsonUtils.getInstance().isJsonObj(data))
            return null;
        return AppConsds.mGson.fromJson(data,SimulationEntity.class);
    }
}
