...
public class FirstResponseConvert implements Converter<FirstResponseEntity> {

    @Override
    public FirstResponseEntity convertResponse(Response response) throws Throwable {
        ...
        if (TextUtils.isEmpty(data) || !JsonUtils.getInstance().isJsonObj(data))
            return null;
        return AppConsds.mGson.fromJson(data,FirstResponseEntity.class);
    }
}
