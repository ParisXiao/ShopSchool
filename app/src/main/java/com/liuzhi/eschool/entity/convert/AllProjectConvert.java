...
public class AllProjectConvert implements Converter<AllProjectEntity> {

    @Override
    public AllProjectEntity convertResponse(Response response) throws Throwable {
        ...
        if (TextUtils.isEmpty(data) || !JsonUtils.getInstance().isJsonObj(data))
            return null;
        return AppConsds.mGson.fromJson(data,AllProjectEntity.class);
    }
}
