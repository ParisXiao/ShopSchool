...
public class ClassDetailConvert implements Converter<ClassDetailEntity> {

    @Override
    public ClassDetailEntity convertResponse(Response response) throws Throwable {
        ...
        if (TextUtils.isEmpty(data) || !JsonUtils.getInstance().isJsonObj(data))
            return null;
        return AppConsds.mGson.fromJson(data,ClassDetailEntity.class);
    }
}
