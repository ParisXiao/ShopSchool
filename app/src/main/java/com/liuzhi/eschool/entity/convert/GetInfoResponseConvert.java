...
public class GetInfoResponseConvert implements Converter<GetIfInfoEntity> {

    @Override
    public GetIfInfoEntity convertResponse(Response response) throws Throwable {
        ...
        if (TextUtils.isEmpty(data) || !JsonUtils.getInstance().isJsonObj(data))
            return null;
        return AppConsds.mGson.fromJson(data,GetIfInfoEntity.class);
    }
}
