...
public class ProjectInfoColConvert implements Converter<ProjectInfoColEntity> {

    @Override
    public ProjectInfoColEntity convertResponse(Response response) throws Throwable {
        ...
        if (TextUtils.isEmpty(data) || !JsonUtils.getInstance().isJsonObj(data))
            return null;
        return AppConsds.mGson.fromJson(data,ProjectInfoColEntity.class);
    }
}
