...
public class ProjectDetailByIdConvert implements Converter<ProjectDetailByIdEntity> {

    @Override
    public ProjectDetailByIdEntity convertResponse(Response response) throws Throwable {
        ...
        if (TextUtils.isEmpty(data) || !JsonUtils.getInstance().isJsonObj(data))
            return null;
        return AppConsds.mGson.fromJson(data,ProjectDetailByIdEntity.class);
    }
}
