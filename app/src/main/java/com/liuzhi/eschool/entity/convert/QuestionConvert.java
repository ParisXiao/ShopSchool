...
public class QuestionConvert implements Converter<QuestionEntity> {

    @Override
    public QuestionEntity convertResponse(Response response) throws Throwable {
        ...
        if (TextUtils.isEmpty(data) || !JsonUtils.getInstance().isJsonObj(data))
            return null;
        return AppConsds.mGson.fromJson(data,QuestionEntity.class);
    }
}
