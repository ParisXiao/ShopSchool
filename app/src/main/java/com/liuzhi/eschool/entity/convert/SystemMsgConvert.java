...
public class SystemMsgConvert implements Converter<SystemMsgEntity> {

    @Override
    public SystemMsgEntity convertResponse(Response response) throws Throwable {
        ...
        if (TextUtils.isEmpty(data) || !JsonUtils.getInstance().isJsonObj(data))
            return null;
        return AppConsds.mGson.fromJson(data,SystemMsgEntity.class);
    }
}
