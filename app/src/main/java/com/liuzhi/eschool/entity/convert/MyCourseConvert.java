...
public class MyCourseConvert implements Converter<MyCourseEntity> {

    @Override
    public MyCourseEntity convertResponse(Response response) throws Throwable {
        ...
        if (TextUtils.isEmpty(data) || !JsonUtils.getInstance().isJsonObj(data))
            return null;
        return AppConsds.mGson.fromJson(data,MyCourseEntity.class);
    }
}
