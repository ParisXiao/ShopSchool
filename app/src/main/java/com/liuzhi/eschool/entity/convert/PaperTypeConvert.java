...
public class PaperTypeConvert implements Converter<PaperTypeEntity> {

    @Override
    public PaperTypeEntity convertResponse(Response response) throws Throwable {
        ...
        if (TextUtils.isEmpty(data) || !JsonUtils.getInstance().isJsonObj(data))
            return null;
        return AppConsds.mGson.fromJson(data,PaperTypeEntity.class);
    }
}
