...
public class UserInfoConvert implements Converter<UserInfoEntity> {

    @Override
    public UserInfoEntity convertResponse(Response response) throws Throwable {
        ...
        if (TextUtils.isEmpty(data) || !JsonUtils.getInstance().isJsonObj(data))
            return null;
        return AppConsds.mGson.fromJson(data,UserInfoEntity.class);
    }
}
