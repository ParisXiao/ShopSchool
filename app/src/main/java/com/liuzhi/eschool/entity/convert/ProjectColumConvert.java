...
public class ProjectColumConvert implements Converter<ProjectColumEntity> {

    @Override
    public ProjectColumEntity convertResponse(Response response) throws Throwable {
        ...
        if (TextUtils.isEmpty(data) || !JsonUtils.getInstance().isJsonObj(data))
            return null;
        return AppConsds.mGson.fromJson(data,ProjectColumEntity.class);
    }
}
