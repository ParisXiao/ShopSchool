...
public class ProjectInfoByConvert implements Converter<ProjectInfoByEntity> {

    @Override
    public ProjectInfoByEntity convertResponse(Response response) throws Throwable {
        ...
        if (TextUtils.isEmpty(data) || !JsonUtils.getInstance().isJsonObj(data))
            return null;
        return AppConsds.mGson.fromJson(data,ProjectInfoByEntity.class);
    }
}
